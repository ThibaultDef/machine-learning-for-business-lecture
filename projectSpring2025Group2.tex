...
\title{Team projects Financial Modeling I}
\author{}
\date{}
...
\textbf{Deadline: 19/04/2024, 23:59,  please submit your *.py or *.ipynb files and a pdf file with the answers 
       using the designated folder on the K2 site of the course.}

\section*{Project 1: Team 1 (Yifei BAI,Felix KNABE, Wei LI), Team 7 (Weizhen Wang, Sarah Hamid Khan, Maria PANTOJA ERAZO) }
...
%  \item In addition to the variables $educ$, $exper$,$female$, use the variables $female \cdot (educ - m)$ instead, where $m$ is the average number of formal education,
...
\section*{Project 2:  Team 2 (Benard Margot, Miet Alice, Azogui Tom,Nobis Marcel), Team 8  (Zhao Meihan,Li Mengfan, Wei Yujiang)}
 ...
 \subsection*{Linear regression for independetly identically sampled data}
  ...
  \begin{enumerate}
   \item Choose randomly two sets of 40 data points from your data set, and for each data set compute the mean, variance, and the histogram
...
\section*{Project 3: Team 3(BOUNEMRA Mohamed Ali,COURBOT Pierre, Moukarzel Christophe,
Heymans Theophile)) Team 9 (Alex Mory,Maxence Piriou, MORANTE  Francesca, BAROUDI Zouhair) }
...
\section*{Project 4: Team 12 (Hoi Ting LUK, Ahmed SHAABAN,Pengfei TANG),  Team 5 (Wu Linhan, Du Tingxuan, Song Xinyao,Yongting Wang), Team 11 (Qingni XU,Rufei YE,Luyu ZENG)}
...
\item Find a linear regression model for predicting $lwage$ using the variables $\log(hours+1)$, $\log(exper+1)$ and $educ$. 
 ...
 \subsection*{Time-series prediction}
    ...
    \url{https://kaggle.com/datasets/04bc82c1251c2480108197dafd684078b0ed02b30cfc9a53d3200ad6b0724aa9} 

    to predict the percentage change in monthly
...
\section*{Project 5: Team 4 (Lingtong Sun,  Lucia Escobar PANIAGUA, SEMILINKO Houefa, YAGO Laurene, MAINET Anne-Lise), Team 10 (Basile de Cointet, GENETET-MOREL Balthazar)}
