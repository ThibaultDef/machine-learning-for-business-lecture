...
\begin{enumerate}
    ...
    \item Compare the means $L_1(w_1)=\frac{1}{n_1} \sum_{i=1}^{n_1} s_{i,1}$ and $L_2(w_2)=\frac{1}{n_2} \sum_{i=1}^{n_2} s_{i,2}$ using a two-sample t-test:
    \[
...
\begin{frame}{Decision Trees}
    ...
    \begin{block}{Example: Decision Tree for Loan Approval}
