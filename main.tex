...
\begin{frame}{Independent samples, independent variables}
   ...
   such that 
	...
	corresponding to the same element (row) of $\widetilde{\Omega}$,
        \item 			
		$X_t$ have the same probability distribution $F$ and they are independent (one variable contains no information on others):
...
be $n$ independent random variables with expectation $\mu$.
